...
<GlobalVariable name='cloud'/> is a managed, automated hosting platform for the Magento Commerce software. <GlobalVariable name='cloud'/> comes with a variety of additional features that sets it apart from the Magento Commerce on-premise and Magento Open Source platforms:
...
<!-- Link definitions -->
[Cloud Benefits]: /cloud/CloudBenefits.png
[Cloud Stack]: /cloud/CloudStack.png
http://localhost:8000/cloud/CloudBenefits.png
http://localhost:8000/cloud/cloud-intro/